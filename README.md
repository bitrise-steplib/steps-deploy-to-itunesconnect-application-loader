...
| `bundle_id` | The bundle identifier of the app to be deployed.  If not provided, the Step will try to read it from the `Info.plist`. |  |  |
| `bundle_version` | The build number of the app to be deployed.  If not provided, the Step will try to read it from the `Info.plist`. |  |  |
| `bundle_short_version` | The version number of the app to be deployed.  If not provided, the Step will try to read it from the `Info.plist`. |  |  |
